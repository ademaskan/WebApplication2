...
const Navbar: React.FC<NavbarProps> = ({ 
    ...
    const handleMouseMove = (e: MouseEvent) => {
        ...
        if (!dragInfo.current.wasDragged && Math.sqrt(dx * dx + dy * dy) > 5) {
    ...
    return (
        <div style={wrapperStyle} ref={navbarRef}>
            <div style={panelStyle} >
                <div onMouseDown={handleMouseDown} style={dragHandleStyle}>
                    ⠿
                </div>
            ...
            <button onMouseDown={handleMouseDown} onClick={handleToggleButtonClick} style={toggleButtonStyle}>
